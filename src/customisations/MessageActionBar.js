...
import {aboveLeftOf, ContextMenu, ContextMenuTooltipButton, useContextMenu} from 'matrix-react-sdk/src/components/structures/ContextMenu';
...
import Toolbar from "matrix-react-sdk/src/accessibility/Toolbar";
import {RovingAccessibleTooltipButton, useRovingTabIndex} from "matrix-react-sdk/src/accessibility/RovingTabIndex";
import {replaceableComponent} from "matrix-react-sdk/src/utils/replaceableComponent";
import {MatrixClientPeg} from 'matrix-react-sdk/src/MatrixClientPeg';
import createRoom, { findDMForUser, privateShouldBeEncrypted } from 'matrix-react-sdk/src/createRoom';
import MatrixClientContext from "matrix-react-sdk/src/contexts/MatrixClientContext";

function canStartDirectMessage(mxEvent) {
...
async function openDMForUser(userId) {
...
export default class MessageActionBar extends React.PureComponent {
    ...
    onDirectMessageClick = (ev) => {
        openDMForUser(this.props.mxEvent.getSender())
    }
    ...
    render() {
        ...
        if(canStartDirectMessage(this.props.mxEvent)) {
            directMessageButton = <RovingAccessibleTooltipButton
                className="mx_MessageActionBar_maskButton mx_MessageActionBar_directMessageButton"
                title={_t("Direct message")}
